...
lose = font3.render('ты проиграл', True, (10, 83, 107))
win = font3.render('ты выйграл', True, (10, 83, 107))
...
while game:
    ...
    if not finish:
        ...
        text = font2.render('счет: ' + str(score), True, (19, 74, 199))

        text_lose = font2.render('пропущено: ' + str(lost), True, (124, 67, 99))
